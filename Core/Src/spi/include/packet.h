...
#define SPI_PACKET_START_AND_END_SIZE \
    SPI_PACKET_START_SIZE + SPI_PACKET_END_SIZE
#define SPI_PACKET_MAX_SIZE \
    SPI_PACKET_START_AND_END_SIZE + SPI_PACKET_MAX_DATA_SIZE
