...
#define SPI_THERMAL_QUERY_LIST                                                                                         \
    X(SPI_THERMAL_QUERY_NOT_USED, 0)                                                                                   \
    ...
    X(SPI_THERMAL_QUERY_STORE_ALL_ERRORS, 6)                                                                           \
    X(SPI_THERMAL_QUERY_GET_ERRORS, 7)                                                                                 \
    X(SPI_THERMAL_QUERY__COUNT, 8)

#define SPI_RADIATION_QUERY_LIST                                                                                       \
    X(SPI_RADIATION_QUERY_NOT_USED, 0)                                                                                 \
    ...
    X(SPI_RADIATION_QUERY_TMP112_TEMP, 5)                                                                              \
    X(SPI_RADIATION_QUERY_EVENT_STATS, 6)                                                                              \
    X(SPI_RADIATION_QUERY_WAVEFORM_CHUNK, 7)                                                                           \
    X(SPI_RADIATION_QUERY__COUNT, 8)

#define SPI_CAMERA_QUERY_LIST                                                                                          \
    X(SPI_CAMERA_QUERY_STARTUP, 0)                                                                                     \
    X(SPI_CAMERA_QUERY_IMG_PARAMS, 1)                                                                                  \
    X(SPI_CAMERA_QUERY_ECHO, 2)                                                                                        \
    X(SPI_CAMERA_QUERY_SEND_SIZE, 3)                                                                                   \
    X(SPI_CAMERA_QUERY_SEND_IMAGE_PACKET, 4)                                                                           \
    X(SPI_CAMERA_QUERY__COUNT, 5)
